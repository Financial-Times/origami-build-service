...
const parseComponentParameter = component => {
	...
	if (!componentName.startsWith('@financial-times/')) {
		throw new UserError(
			`The component query parameter can only contain components from the @financial-times namespace. The component being requested was: ${componentName}.`
		);
	}
