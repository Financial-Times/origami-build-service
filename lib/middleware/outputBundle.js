...
module.exports = config => {
	...
	return function createBundle(req, res, next) {
		outputBundle(req.params.type, req, res, next);
	};
	...
	function outputBundle(type, req, res, next) {
			...
			if (type === 'demo') {
				...
				moduleInstallationPromise = installationManager.createInstallation(moduleset, bundleDetails);
			}
