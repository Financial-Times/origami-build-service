...
const httpProxyTtl = 12 * oneHourMSec;

function surrogateControlHeaderFromExpiry(expiryTime) {
	...
	const sMaxAge = Math.ceil(httpProxyTtl / 1000);
...
module.exports = surrogateControlHeaderFromExpiry;
