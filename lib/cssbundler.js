...
CssBundler.prototype = {
	...
	createMainFile: Q.async(function* (installation, moduleset, brand, mainScriptPath, options) {
		...
		const mainSassDescription = this._compileSassFiles(installation, requestedComponents, allComponents, brand, opts);
	...
	_compileSassFiles: function (installation, requestedComponents, allComponents, brand) {
		const variables = {};
