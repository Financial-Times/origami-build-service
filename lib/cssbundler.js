...
CssBundler.prototype = {
	...
	createMainFile: Q.async(function* (installation, moduleset, brand, mainScriptPath, options) {
		...
		const mainSassDescription = this._compileSassFiles(installation, requestedComponents, allComponents, opts, brand);
	...
	_compileSassFiles: function (installation, requestedComponents, allComponents, opts, brand) {
		const variables = {};

		variables['o-table-brand'] = brand;
