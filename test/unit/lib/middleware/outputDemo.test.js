...
describe('lib/middleware/outputDemo', function() {
	...
	describe('outputDemo(app, {outputMinimalHtml: true})', () => {
		...
		describe('middleware(request, response, next)', () => {
			...
			describe('when the demo contains an element with a registry demo chunk class', () => {
					...
					bundle.toString = sinon.stub().returns(`
						...
						<html lang="en">
							...
							<body>
								...
								<div class="mock-demo o-registry-demo-chunk">
									<p>mock demo chunk content</p>
								</div>
				...
				it('sends that element HTML instead of the body contents', () => {
					return middleware(request, response, next).then(() => {
						assert.strictEqual(response.send.firstCall.args[0].replace(/\s+/g, ' ').trim(), `
							<div class="mock-demo">
								<p>mock demo chunk content</p>
			...
			describe('when the demo contains multiple elements with a registry demo chunk class', () => {
					...
					bundle.toString = sinon.stub().returns(`
						...
						<html lang="en">
							...
							<body>
								...
								<div class="mock-demo-2 o-registry-demo-chunk">
									<p>mock demo chunk content 2</p>
								</div>
				...
				it('sends the first element HTML', () => {
					return middleware(request, response, next).then(() => {
						assert.strictEqual(response.send.firstCall.args[0].replace(/\s+/g, ' ').trim(), `
							<div class="mock-demo">
								<p>mock demo chunk content</p>
			...
			describe('when the demo contains an element with a registry demo chunk class and no other classes', () => {
					...
					bundle.toString = sinon.stub().returns(`
						...
						<html lang="en">
							...
							<body>
								...
								<div class="o-registry-demo-chunk">
									<p>mock demo chunk content</p>
								</div>
				...
				it('strips the class attribute before sending', () => {
					return middleware(request, response, next).then(() => {
						assert.strictEqual(response.send.firstCall.args[0].replace(/\s+/g, ' ').trim(), `
							<div>
								<p>mock demo chunk content</p>
