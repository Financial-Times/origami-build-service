...
describe('lib/middleware/v3/createEntryFileJavaScript', () => {
    ...
    beforeEach(() => {
        createEntryFileJavaScript = require('../../../../../lib/middleware/v3/createEntryFileJavaScript').createEntryFileJavaScript;
    });
    ...
    it('creates a index.js file in the specified location and with the specified modules as imported and added to the Origami global variable', async function() {
        ...
        const EntryFileContents = await fs.readFile(path.join(location, 'index.js'), 'utf-8');
        proclaim.deepStrictEqual(EntryFileContents, dedent`
