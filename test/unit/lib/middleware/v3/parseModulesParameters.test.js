...
const {parseModulesParameter} = require('../../../../../lib/middleware/v3/parseModulesParameter');
...
describe('parseModulesParameter', () => {
    ...
    it('returns a Map where the key is the module name and the value is the version range', async () => {
        ...
        proclaim.deepStrictEqual(parseModulesParameter('lodash@^5,preact@^10.5.5,@financial-times/o-table@100'), modules);
    });
});
