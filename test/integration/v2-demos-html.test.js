...
describe('GET /__origami/service/build/v2/demos', function() {
	...
	describe('when a valid module and demo are requested', function() {
		...
		before(async function () {
			response = await request(this.app)
				.get(`/__origami/service/build/v2/demos/${moduleName}/${pathName}/html`)
				.redirects(5)
				.set('Connection', 'close');
		});
	...
	describe('when a valid module and no demo is requested', function() {
		...
		before(async function () {
			response = await request(this.app)
				.get(`/__origami/service/build/v2/demos/${moduleName}/`)
				.redirects(5)
				.set('Connection', 'close');
		});
	...
	describe('when a valid module at specific version and demo and brand are requested', function() {
		...
		before(async function () {
			response = await request(this.app)
				.get(`/__origami/service/build/v2/demos/${moduleName}/${pathName}/html?brand=internal`)
				.redirects(5)
				.set('Connection', 'close');
		});
