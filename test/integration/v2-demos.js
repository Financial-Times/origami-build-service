...
describe('GET /v2/demos', function() {
	...
	describe('when a valid module at non-existent version is requested', function() {
		...
		it('should respond with an error message in a comment', function(done) {
			this.request.expect('/*\n\nNo tag found that was able to satisfy 99.0.0\nAvailable versions: 4.5.1, 4.5.0, 4.4.4, 4.4.3, 4.4.2, 4.4.1, 4.4.0, 4.3.1, 4.3.0, 4.2.0, 4.1.1, 4.1.0, 4.0.2, 4.0.1, 4.0.0, 3.1.4, 3.1.3, 3.1.2, 3.1.1, 3.1.0, 3.0.3, 3.0.2, 3.0.1, 3.0.1-beta.1, 3.0.0, 3.0.0-beta.7, 3.0.0-beta.6, 3.0.0-beta.5, 3.0.0-beta.4, 3.0.0-beta.3, 3.0.0-beta.2, 3.0.0-beta.1, 2.0.4, 2.0.3, 2.0.2, 2.0.1, 2.0.0, 1.8.1, 1.8.0, 1.7.5, 1.7.4, 1.7.3, 1.7.2, 1.7.1, 1.7.0, 1.6.0, 1.5.4, 1.5.3, 1.5.2, 1.5.1, 1.5.0, 1.4.1, 1.4.0, 1.3.0, 1.2.0, 1.1.1, 1.1.0, 1.0.6, 1.0.5, 1.0.4, 1.0.3, 1.0.2, 1.0.1, 1.0.0, 0.2.0, 0.1.6, 0.1.5, 0.1.4, 0.1.3, 0.1.2, 0.1.1, 0.1.0\n\n{\n  "endpoint": {\n    "name": "o-buttons",\n    "source": "o-buttons",\n    "target": "99.0.0"\n  },\n  "resolver": {\n    "name": "o-buttons",\n    "source": "https://github.com/Financial-Times/o-buttons.git",\n    "target": "99.0.0"\n  }\n}\n\n*/\n').end(done);
		});
