...
describe('GET /v2/modules', function() {
	...
	describe('when a valid module is requested', function() {
		...
		it('should respond with the module information', function() {
...
describe('GET /__origami/service/build/v2/modules', function() {
	this.timeout(20000);
	this.slow(5000);
	...
	describe('when a valid module is requested', function() {
		...
		before(async function () {
			response = await request(this.app)
				.get(`/__origami/service/build/v2/modules/${moduleName}`)
				.redirects(5)
				.set('Connection', 'close');
		});
