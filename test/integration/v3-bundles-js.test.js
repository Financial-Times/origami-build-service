...
describe('GET /__origami/service/build/v3/bundles/js', function() {
	...
	describe('when an invalid component is requested (origami v3)', function() {
		...
		it('should respond with an error message', function(done) {
			this.request.expect('Origami Build Service returned an error: "o3-utils@1 is not an Origami v2 component, the Origami Build Service v3 API only supports Origami v2 components."').end(done);
		});
